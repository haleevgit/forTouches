System.register(["./application.b3e0c.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_applicationB3e0cJs) {
      createApplication = _applicationB3e0cJs.createApplication;
    }],
    execute: function () {
      createApplication({
